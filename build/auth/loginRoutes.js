...
router.post('/login', async (req, res) => {
    ...
    const { client_id, redirect_uri, scope, state, code_challenge, code_challenge_method, } = req.session.oauthParams;
...
router.get('/google/callback', async (req, res) => {
    ...
    try {
        ...
        // Extract OAuth params from session
        const { client_id, redirect_uri, scope, state: oauthState, code_challenge, code_challenge_method, } = req.session.oauthParams;
        // Generate authorization code
